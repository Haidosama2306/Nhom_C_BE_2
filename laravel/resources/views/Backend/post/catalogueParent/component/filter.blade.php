<form action="{{ route('post.catalogue.parent.index') }}">
    ...
    <div class="uk-flex uk-flex-middle uk-flex-space-between">
        ...
        <div class="action">
            <div class="uk-flex uk-flex-middle">
                ...
                <a href="{{ route('post.catalogue.parent.store') }}" class="btn btn-danger ml10"><i class="fa fa-plus mr5"></i>Thêm mới nhóm bài viết cha</a>
            </div>
        </div>
    </div>
</div>
